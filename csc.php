    ...
    <div class="text" style="float:left;margin-left:40%;margin-top:-15%;width:120%">OCL</div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right" ">
					...
					<nav class="navbar navbar-default " role="navigation" style="width:6%;margin-left:45%;height:7%;background-color:transparent;border:0px solid black">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown" >
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><b>Login</b> <span class="caret"></span></a>
			<ul id="login-dp" class="dropdown-menu" style="background-color:white;text-transform: capitalize;">
					 ...
					 <div class="row">
							...
							<div class="col-md-12" style="background-color:white"  >
								...
								<div class="social-buttons"  >
								 ...
								 <form class="form" role="form" method="post" action="logg.php" accept-charset="UTF-8" id="login-nav" style="background-color:white">
										...
										<div class="form-group">
											 <button type="button" onclick="login( document.getElementById('loginemail').value  , document.getElementById('loginpassword').value   )" class="btn btn-primary btn-block">Sign in</button>
										</div>
										<div class="checkbox">
											 <label>
							...
							<div class="bottom text-center">
								<a href="#" data-toggle="modal"  data-target="#myModal" style="background-color:transparent;border:0px solid black"><b></b></a>
        ...
        <div class="container">
            ...
            <div class="row">
				...
				<div class="col-lg-8 col-lg-offset-5  ">
					...
					<img src="kis.png" class="img-circle" style="height:35%; width:35%;margin-top:-50%;margin-left:-5%;margin-right:50%"> 
				...
				<div class="col-lg-8 col-lg-offset-9 ">
					...
					<img src="ash.png" class="img-circle" style="height:35%; width:35%;margin-top:-50%;margin-left:-2%;"> 
...
<div class="form-group">
			...
			<div class="row">
				<div class="col-xs-4 col-sm-3 col-md-3">
                     ...
                     <img id="varun/captcha.php" width="120" height="30" border="1" alt="CAPTCHA">
...
function emailavailable(email){
	...
	//alert(xmlhttp.responseText);
        ...
        xmlhttp.open("GET","http://localhost/csce/api.php?req=10&email="+email,true); //sending username and password to a php file to verify credentials
...
if (window.XMLHttpRequest) {
	...
	//alert(xmlhttp.responseText);
        ...
        xmlhttp.open("GET","http://localhost/csce/api.php?req=1&fname="+fname+"&lname="+lname+"&gender="+gender+"&email="+email+"&password="+password,true); //sending username and password to a php file to verify credentials
        xmlhttp.send();//true in above statement means data is sent asynchronously obvious as AJAX ki full form 
...
//alert(localStorage.getItem("fname"));
    ...
    window.location.assign("./post.php");
        ...
        xmlhttp.open("GET","http://localhost/csce/api.php?req=2&emailid="+email+"&password="+password,true); //sending username and password to a php file to verify credentials
        xmlhttp.send();//true in above statement means data is sent asynchronously obvious as AJAX ki full form 
